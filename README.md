...
Critiquing real-world clinical data collection forms (CRFs) for design flaws
Building a complete data dictionary defining variable types, formats, coding, ranges, and missing value conventions
Creating fabricated study data following data dictionary specifications
Importing Excel data into R using readxl
Generating descriptive statistics (mean, median, min, max) in R
Writing and knitting R Markdown documents to PDF
